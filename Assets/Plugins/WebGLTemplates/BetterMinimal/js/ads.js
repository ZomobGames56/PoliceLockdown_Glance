var gameInput = { gameName: '[Game name]', publisherName: '[studio name]' };
...
function runOnAdClosed() {
    if (_triggerReason === 'replay') {
        ...
        if (!isRewardGranted && isRewardedAdClosedByUser) {
            ...
            unityInstance.SendMessage("PlatformLoader", "rewardAdFailure");
        } else {

            console.log("Ad Success");
            unityInstance.SendMessage("PlatformLoader", "rewardAdSuccess");
